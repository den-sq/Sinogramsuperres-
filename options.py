...
class Options():
	...
	def init(self, parser):
		...
		parser.add_argument('--pretrain_weights', type=str, default='./log/Uformer_B/models/model_best.pth',
		...
		parser.add_argument('--gpu', type=str, default='5', help='GPUs')
		parser.add_argument('--arch', type=str, default='Drht', help='architechture, opts=Unet/Drht')
		...
		# parser.add_argument('--train_dir', type=str, default='/data/sisrzebra/train/', help='dir of train data')
		# parser.add_argument('--val_dir', type=str, default='/data/sisrzebra/test/', help='dir of train data')
		parser.add_argument('--train_dir', type=str, default='/gpuhome/aus79/data/seasct/', help='dir of train data')
		parser.add_argument('--val_dir', type=str, default='/gpuhome/aus79/data/seasct/', help='dir of train data')
		parser.add_argument('--warmup', action='store_true', default=False, help='warmup')
		parser.add_argument('--warmup_epochs', type=int, default=3, help='epochs for warmup')
		parser.add_argument('--upscale', type=int, default=4, help='2/4/8')
		# ddp
		parser.add_argument("--local_rank", type=int, default=-1, help='DDP parameter, do not modify')  # 不需要赋值，启动命令 torch.distributed.launch会自动赋值 # noqa: E501
